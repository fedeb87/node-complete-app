...
module.exports = {
  ...
  update: ( req, res, next ) => {
    ...
    Subscriber.findByIdAndUpdate( subscriberId, {
      ...
      .then( subscriber => {
        req.flash("success", `${subscriberParams.name}'s subscriber updated successfully!`);
      ...
      .catch( error => {
        req.flash("error",
          `Error updating subscriber by ID: ${error.message}`
        );
  ...
  delete: ( req, res, next ) => {
    ...
    Subscriber.findByIdAndRemove( subscriberId )
      ...
      .catch( error => {
        req.flash("error",
          `Error deleting subscriber by ID: ${error.message}`
        );
